#!/usr/bin/env python3
"""
OpenMind — AI assistant CLI.

Usage:
  python openmind.py [options] [prompt]
...
def repl(config: dict, initial_prompt: str = None):
    ...
    def run_query(user_input: str):
        ...
        print(clr("\n╭─ OpenMind ", "dim") + clr("●", "green") + clr(" ───────────────────────", "dim"))
...
def main():
    parser = argparse.ArgumentParser(
        prog="openmind",
        description="OpenMind — AI assistant CLI",
        add_help=False,
    )
