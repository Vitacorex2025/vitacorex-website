...
ASSET_DOWNLOADS = {
    "executive-brief": "/assets/briefs/vitacorex-executive-brief.pdf",
    "pilot-structure": "/assets/briefs/vitacorex-pilot-structure.pdf",
    "file-control-sample": "/assets/briefs/vitacorex-file-control-sample.pdf",
}
