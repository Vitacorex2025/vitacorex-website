...
from backend.main import APP_ROOT, FRONTEND_ROOT, app as core_app
...
app = FastAPI(title="VitaCoreX Public Runtime", docs_url=None, redoc_url=None, openapi_url=None)
