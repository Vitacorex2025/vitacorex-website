...
ARCHIVE_NAME = "docketmint_layer3_truth_engine_deterministic_routing_2026-03-19.zip"
MANIFEST_NAME = "docketmint_layer3_truth_engine_deterministic_routing_2026-03-19_manifest.json"

DEST = ROOT / ARCHIVE_NAME
MANIFEST = ROOT / MANIFEST_NAME
DESKTOP_DEST = DESKTOP / ARCHIVE_NAME
DESKTOP_MANIFEST = DESKTOP / MANIFEST_NAME
EXTRACT_DIR = ROOT / "tmp_zip_validate" / "layer3_truth_engine_extract"
...
KEY_FILES = [
    "backend/models/case_schema.py",
    "backend/services/file_classifier.py",
    "backend/services/excel_parser.py",
    "backend/services/file_ingestion.py",
    "backend/services/matter_validator.py",
    "backend/services/case_extractor.py",
    ...
    "backend/services/recovery_intake_service.py",
    "backend/tests/test_ingestion_hardening.py",
    "backend/tests/test_recovery_routing_engine.py",
    "LAYER3_TRUTH_ENGINE_ROUTING_REPORT.md",
    "LAYER3_CHANGED_FILES.txt",
    "LAYER3_VALIDATION_REPORT.md",
]
