...
ARCHIVE_NAME = "docketmint_layer4_recovery_workspace_packets_2026-03-19.zip"
MANIFEST_NAME = "docketmint_layer4_recovery_workspace_packets_2026-03-19_manifest.json"

DEST = ROOT / ARCHIVE_NAME
MANIFEST = ROOT / MANIFEST_NAME
DESKTOP_DEST = DESKTOP / ARCHIVE_NAME
DESKTOP_MANIFEST = DESKTOP / MANIFEST_NAME
EXTRACT_DIR = ROOT / "tmp_zip_validate" / "layer4_workspace_extract"
...
KEY_FILES = [
    ...
    "backend/services/recovery_workspace_service.py",
    "backend/api/routes/cases.py",
    "backend/services/generation_service.py",
    "backend/services/download_ledger.py",
    ...
    "LAYER4_WORKSPACE_PACKETS_REPORT.md",
    "LAYER4_CHANGED_FILES.txt",
    "LAYER4_VALIDATION_REPORT.md",
]
