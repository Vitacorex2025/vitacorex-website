...
ARCHIVE_NAME = "docketmint_layer6_7_monetization_public_trust_2026-03-19.zip"
MANIFEST_NAME = "docketmint_layer6_7_monetization_public_trust_2026-03-19_manifest.json"

DEST = ROOT / ARCHIVE_NAME
MANIFEST = ROOT / MANIFEST_NAME
DESKTOP_DEST = DESKTOP / ARCHIVE_NAME
DESKTOP_MANIFEST = DESKTOP / MANIFEST_NAME
EXTRACT_DIR = ROOT / "tmp_zip_validate" / "layer6_7_monetization_public_trust_extract"
...
KEY_FILES = [
    "index.html",
    "LAYER6_MONETIZATION_REPORT.md",
    "LAYER7_PUBLIC_TRUST_REPORT.md",
    "LAYER6_7_CHANGED_FILES.txt",
    "LAYER6_7_VALIDATION_REPORT.md",
    "LAYER6_7_KNOWN_ISSUES.md",
    "assets/snippets/vitacorex_recovery_os_cta.html",
