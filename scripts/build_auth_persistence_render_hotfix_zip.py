...
ARCHIVE_NAME = "docketmint_auth_persistence_render_hotfix_2026-03-20.zip"
MANIFEST_NAME = "docketmint_auth_persistence_render_hotfix_2026-03-20_manifest.json"

DEST = ROOT / ARCHIVE_NAME
MANIFEST = ROOT / MANIFEST_NAME
DESKTOP_DEST = DESKTOP / ARCHIVE_NAME
DESKTOP_MANIFEST = DESKTOP / MANIFEST_NAME
EXTRACT_DIR = ROOT / "tmp_zip_validate" / "auth_persistence_render_hotfix_extract"
...
ROOT_FILE_NAMES = {
    ...
    "styles.css",
    "vercel.json",
    "AUTH_PERSISTENCE_RENDER_HOTFIX_REPORT_2026-03-20.md",
    "AUTH_PERSISTENCE_RENDER_HOTFIX_CHANGED_FILES_2026-03-20.txt",
    "AUTH_PERSISTENCE_RENDER_HOTFIX_VALIDATION_2026-03-20.md",
}
