...
ARCHIVE_NAME = "docketmint_layer2_auth_rbac_upload_first_2026-03-19.zip"
MANIFEST_NAME = "docketmint_layer2_auth_rbac_upload_first_2026-03-19_manifest.json"

DEST = ROOT / ARCHIVE_NAME
MANIFEST = ROOT / MANIFEST_NAME
DESKTOP_DEST = DESKTOP / ARCHIVE_NAME
DESKTOP_MANIFEST = DESKTOP / MANIFEST_NAME
EXTRACT_DIR = ROOT / "tmp_zip_validate" / "layer2_auth_upload_first_extract"
...
KEY_FILES = [
    ...
    "backend/api/routes/recovery_intake.py",
    "backend/main.py",
    "backend/services/platform_history.py",
    "assets/js/api-client.js",
    "assets/js/app-shell.js",
    "assets/js/intake-router.js",
    "assets/js/home.js",
    "assets/js/platform-services.js",
    "assets/js/services-page.js",
    "assets/js/auth.js",
    "assets/js/camera-intake.js",
    "assets/js/case-intake.js",
    "assets/css/app-shell.css",
    "app/home/index.html",
    "app/new-case/index.html",
    "app/case-intake/index.html",
    "backend/tests/test_admin_rbac.py",
    "backend/tests/test_api.py",
    "backend/tests/test_auth_isolation.py",
    "backend/tests/test_shell_architecture.py",
    "backend/tests/test_workflow_rebuild.py",
    "LAYER2_AUTH_RBAC_UPLOAD_FIRST_REPORT.md",
    "LAYER2_CHANGED_FILES.txt",
    "LAYER2_VALIDATION_REPORT.md",
]
