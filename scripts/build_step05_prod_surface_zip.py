...
DEST = ROOT / "docketmint_step05_prod_surface_cleanup_2026-03-19.zip"
MANIFEST = ROOT / "docketmint_step05_prod_surface_cleanup_2026-03-19_manifest.json"
EXTRACT_DIR = ROOT / "tmp_zip_validate" / "step05_prod_surface_cleanup_extract"
...
KEY_FILES = [
    "PROD_SURFACE_CLEANUP_REPORT.md",
    "CHANGED_FILES.txt",
    ...
    "app/settings-support/index.html",
