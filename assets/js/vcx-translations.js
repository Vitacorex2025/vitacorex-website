...
en: {
  ...
  /* ── Testimonials ──────────────────────────────────────────── */
  test_eyebrow:       'Client perspectives',
  test_title:         'Trusted by operators who demand disciplined execution.',
  test_1_text:        'VitaCoreX restructured our entire recovery workflow. Within 60 days, we reduced aged balances by 40% and eliminated the need for two external agencies.',
  test_1_name:        'J. Martinez',
  test_1_role:        'CFO, Multi-Location Healthcare Group',
  test_2_text:        'The packet discipline alone saved us over $200K in outside counsel cleanup costs. Our files are now audit-ready before escalation even begins.',
  test_2_name:        'D. Kowalski',
  test_2_role:        'General Counsel, Fleet Services Corp',
  test_3_text:        'We went from fragmented billing across 12 locations to a unified recovery infrastructure in one 90-day pilot. The proof was undeniable to our board.',
...
ru: {
  ...
  test_eyebrow:       'Отзывы клиентов',
  test_title:         'Нам доверяют операторы, требующие дисциплинированного исполнения.',
  test_1_text:        'VitaCoreX перестроила весь наш процесс возврата. За 60 дней мы сократили просроченные балансы на 40% и устранили необходимость в двух внешних агентствах.',
  test_1_name:        'Х. Мартинес',
  test_1_role:        'CFO, Многолокационная группа здравоохранения',
  test_2_text:        'Только дисциплина пакетов сэкономила нам более $200 000 на расходах по очистке внешними юристами. Наши файлы теперь готовы к аудиту до начала эскалации.',
  test_2_name:        'Д. Ковальски',
  test_2_role:        'Главный юрист, Fleet Services Corp',
  test_3_text:        'Мы перешли от фрагментированного биллинга по 12 локациям к единой инфраструктуре возврата за один 90-дневный пилот. Доказательства были неопровержимы для нашего совета директоров.',
  test_3_name:        'С. Ривз',
...
es: {
  ...
  test_eyebrow:       'Perspectivas de clientes',
  test_title:         'Confiado por operadores que exigen ejecucion disciplinada.',
  test_1_text:        'VitaCoreX reestructuro todo nuestro flujo de recuperacion. En 60 dias, redujimos los saldos envejecidos en un 40% y eliminamos la necesidad de dos agencias externas.',
  test_1_name:        'J. Martinez',
  test_1_role:        'CFO, Grupo de Salud Multi-Ubicacion',
  test_2_text:        'Solo la disciplina de paquetes nos ahorro mas de $200K en costos de limpieza de abogados externos. Nuestros archivos ahora estan listos para auditoria antes de que el escalamiento siquiera comience.',
  test_2_name:        'D. Kowalski',
  test_2_role:        'Asesor General, Fleet Services Corp',
  test_3_text:        'Pasamos de facturacion fragmentada en 12 ubicaciones a una infraestructura de recuperacion unificada en un piloto de 90 dias. La prueba fue innegable para nuestra junta.',
  test_3_name:        'S. Reeves',
